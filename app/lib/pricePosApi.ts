...
export async function createPricePos(data: CreatePricePosRequest): Promise<PricePos> {
  try {
    ...
    if (!response.ok) {
      ...
      handleApiError(error, `Failed to create price POS mapping: ${response.statusText}`);
    }
...
export async function bulkCreatePricePos(data: BulkCreatePricePosRequest): Promise<BulkCreatePricePosResponse> {
  try {
    const response = await fetch(`${BACKEND_URL}/api/price-pos/bulk`, {
      method: 'POST',
      headers: getAuthHeaders(),
      body: JSON.stringify(data),
    });
    ...
    if (!response.ok) {
      const error = await response.json();
      handleApiError(error, `Failed to bulk create price POS mappings: ${response.statusText}`);
    }
...
export async function getPricePos(
  ...
  try {
    ...
    const response = await fetch(`${BACKEND_URL}/api/price-pos/?${params}`, {
      method: 'GET',
      headers: getAuthHeaders(),
      cache: 'no-store',
    });
    ...
    if (!response.ok) {
      const error = await response.json();
      handleApiError(error, `Failed to fetch price POS mappings: ${response.statusText}`);
    }
...
export async function getPricePosById(entryId: number): Promise<PricePos> {
  try {
    const response = await fetch(`${BACKEND_URL}/api/price-pos/${entryId}`, {
      method: 'GET',
      headers: getAuthHeaders(),
      cache: 'no-store',
    });
    ...
    if (!response.ok) {
      const error = await response.json();
      handleApiError(error, `Failed to fetch price POS mapping: ${response.statusText}`);
    }
...
export async function getPricePosByState(
  ...
  try {
    ...
    const response = await fetch(`${BACKEND_URL}/api/price-pos/by-state/${encodeURIComponent(state)}?${params}`, {
      method: 'GET',
      headers: getAuthHeaders(),
      cache: 'no-store',
    });
    ...
    if (!response.ok) {
      const error = await response.json();
      handleApiError(error, `Failed to fetch price POS mappings by state: ${response.statusText}`);
    }
...
export async function getPricePosByPos(
  ...
  try {
    ...
    const response = await fetch(`${BACKEND_URL}/api/price-pos/by-pos/${encodeURIComponent(pointOfSale)}?${params}`, {
      method: 'GET',
      headers: getAuthHeaders(),
      cache: 'no-store',
    });
    ...
    if (!response.ok) {
      const error = await response.json();
      handleApiError(error, `Failed to fetch price POS mappings by POS: ${response.statusText}`);
    }
...
export async function getPricePosByPromoter(
  ...
  try {
    ...
    const response = await fetch(`${BACKEND_URL}/api/price-pos/by-promoter/${encodeURIComponent(promoter)}?${params}`, {
      method: 'GET',
      headers: getAuthHeaders(),
      cache: 'no-store',
    });
    ...
    if (!response.ok) {
      const error = await response.json();
      handleApiError(error, `Failed to fetch price POS mappings by promoter: ${response.statusText}`);
    }
...
export async function getPricePosByPricelist(
  ...
  try {
    ...
    const response = await fetch(`${BACKEND_URL}/api/price-pos/by-pricelist/${encodeURIComponent(pricelist)}?${params}`, {
      method: 'GET',
      headers: getAuthHeaders(),
      cache: 'no-store',
    });
    ...
    if (!response.ok) {
      const error = await response.json();
      handleApiError(error, `Failed to fetch price POS mappings by pricelist: ${response.statusText}`);
    }
...
export async function updatePricePos(
  ...
  try {
    ...
    if (!response.ok) {
      const error = await response.json();
      handleApiError(error, `Failed to update price POS mapping: ${response.statusText}`);
    }
...
export async function deletePricePos(entryId: number): Promise<void> {
  try {
    ...
    if (!response.ok) {
      ...
      handleApiError(error, `Failed to delete price POS mapping: ${response.statusText}`);
    }
  } catch (error) {
...
export async function deletePricePosByPos(pointOfSale: string): Promise<void> {
  try {
    const response = await fetch(`${BACKEND_URL}/api/price-pos/by-pos/${encodeURIComponent(pointOfSale)}`, {
      method: 'DELETE',
      headers: {
        ...getAuthHeaders(),
        'accept': '*/*',
    ...
    if (!response.ok) {
      const error = await response.json().catch(() => ({}));
      handleApiError(error, `Failed to delete price POS mappings by POS: ${response.statusText}`);
    }
  } catch (error) {
...
export async function getPricePosStatsOverview(): Promise<PricePosStatsOverview> {
  try {
    const response = await fetch(`${BACKEND_URL}/api/price-pos/stats/overview`, {
      method: 'GET',
      headers: getAuthHeaders(),
      cache: 'no-store',
    });
    ...
    if (!response.ok) {
      const error = await response.json();
      handleApiError(error, `Failed to fetch price POS stats overview: ${response.statusText}`);
    }
...
export async function getPricePosStatsByState(): Promise<PricePosStatsByState[]> {
  try {
    const response = await fetch(`${BACKEND_URL}/api/price-pos/stats/by-state`, {
      method: 'GET',
      headers: getAuthHeaders(),
      cache: 'no-store',
    });
    ...
    if (!response.ok) {
      const error = await response.json();
      handleApiError(error, `Failed to fetch price POS stats by state: ${response.statusText}`);
    }
...
export async function getPricePosStatsByPromoter(): Promise<PricePosStatsByPromoter[]> {
  try {
    const response = await fetch(`${BACKEND_URL}/api/price-pos/stats/by-promoter`, {
      method: 'GET',
      headers: getAuthHeaders(),
      cache: 'no-store',
    });
    ...
    if (!response.ok) {
      const error = await response.json();
      handleApiError(error, `Failed to fetch price POS stats by promoter: ${response.statusText}`);
    }
...
export async function getPricePosStatsByPricelist(): Promise<PricePosStatsByPricelist[]> {
  try {
    const response = await fetch(`${BACKEND_URL}/api/price-pos/stats/by-pricelist`, {
      method: 'GET',
      headers: getAuthHeaders(),
      cache: 'no-store',
    });
    ...
    if (!response.ok) {
      const error = await response.json();
      handleApiError(error, `Failed to fetch price POS stats by pricelist: ${response.statusText}`);
    }
...
export async function getUniqueStates(): Promise<string[]> {
  try {
    const response = await fetch(`${BACKEND_URL}/api/price-pos/lists/states`, {
      method: 'GET',
      headers: getAuthHeaders(),
      cache: 'no-store',
    });
...
export async function getUniquePos(): Promise<string[]> {
  try {
    const response = await fetch(`${BACKEND_URL}/api/price-pos/lists/pos`, {
      method: 'GET',
      headers: getAuthHeaders(),
      cache: 'no-store',
    });
    ...
    if (!response.ok) {
      const error = await response.json();
      handleApiError(error, `Failed to fetch unique POS: ${response.statusText}`);
    }
...
export async function getUniquePromoters(): Promise<string[]> {
  try {
    ...
    if (!response.ok) {
      const error = await response.json();
      handleApiError(error, `Failed to fetch unique promoters: ${response.statusText}`);
    }
...
export async function getUniquePricelists(): Promise<string[]> {
  try {
    const response = await fetch(`${BACKEND_URL}/api/price-pos/lists/pricelists`, {
      method: 'GET',
      headers: getAuthHeaders(),
      cache: 'no-store',
    });
